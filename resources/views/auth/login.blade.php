...
@section('content')
    <header class="masthead" style="background-image: url('assets/img/home-bg.jpg'); height:100vh; margin: 0">
            ...
            <div id="page-wrapper">
                ...
                <div id="main-wrapper">
                    <div class="container rounded" style="max-width: 500px; background-color: white; padding: 16px;">
                        <form method='POST'>
                            @csrf
                            <h3 class="text-center mb-4" style="color: #007189">Log in</h3>
                            <!-- Email input -->
                            @error('email')
                                ...
                                <div class="col d-flex">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="remember" type="checkbox"
                                            {{ old('remember') ? 'checked' : '' }} id="form2Example31" />
                            ...
                            <p class="m-0 text-center" style="font-size: 16px">Does not have an account? <a
